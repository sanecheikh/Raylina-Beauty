...
<img loading="lazy" width="1536" height="2049" class="wp-block-cover__image-background wp-image-1574" alt="" src="./assets/img/coupehome.jpg" data-object-fit="cover"data-object-position="49% 70%" srcset="./assets/img/coupehome.jpg  1536w",
 /><div class="wp-block-cover__inner-container">
<h2 class="has-text-align-left has-text-color"><a href="index.php?page=prestation-homme" data-type="page" data-id="2044"> Prestations homme</a></h2>
</div>
</div>
</div>
</div>
...
<script type="text/javascript" charset="utf-8" src="index.php?page=salon/wp-content/uploads/hypeanimations/1/sbarber.hyperesources/sbarber_hype_generated_script.js?77565"></script> 
 ...
 <div id ="col" class="pt-1 px-5"> 

	                  <p class ="fs-1" style="font-size:larger ;"> Creer en 2019 salon de beaute ,cosmetique et soins</p>
     <p>Se faire beau ou belle est très important pour la confiance en soi. 
                     ...
                     Vous pourrez découvrir nos divers soins qui vous sublimeront de la tête aux pieds.
                     Grâce à nos professionnels de la coiffure à Rouen, nous mettons à votre disposition un savoir-faire et des compétences hors normes. 
                     ...
                     <p>
     <p class ="fs-1" style="font-size:larger"> Une équipe de coiffeurs et de coiffeuses hautement qualifiée pour sublimer votre beauté et révéler votre personnalité</p>
 <p>Chez Raylina Beauty, c’est la satisfaction à tout prix. Nos professionnels de la coiffure se chargeront de mettre en forme vos envies de coiffures de tout genre.
                              ...
                              Avec une belle ambiance, une musique relaxante, et une décoration élégante, notre salon de beauté est l’endroit idéal pour se faire belle tout en gardant son style et son attitude branchée.
                  Notre adresse est la suivante : 55 rue de la république Rouen, et nous répondons au numéro de téléphone suivant : 09 82 44 70 05. 
                    Une brillante équipe de stylistes, visagistes et coloristes avec pour seul but de sublimer votre chevelure est à votre disposition. Pour tous les hommes et les femmes en quête de mise en beauté, de tendance et de changement, nous savons parfaitement ce qu’il vous faut.
                   Tout ce que vous aurez à faire c’est de vous laisser guider par les conseils d’un bon coiffeur à Rouen que nous mettrons à votre disposition. 
                    Passer du court au long, du long au court, oser des mèches, des extensions, un lissage, une coloration ou une frange avec nos spécialistes de la coiffure Rouen sans aucune pression. 
						 ...
						 <p class ="fs-1"style="font-size:larger"> Des produits de beauté d’exception pour vous sublimer encore plus </p>
