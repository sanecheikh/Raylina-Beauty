    ...
    <div class="ct-drawer-canvas">
        <div id="offcanvas" class="ct-panel ct-header" data-behaviour="modal">
            ...
            <div class="ct-header-socials " data-id="socials">
                <div class="ct-social-box" data-icon-size="custom" data-color="custom" data-icons-type="simple"><a href="https://www.facebook.com/lamaisonbysbarber" data-network="facebook" aria-label="Facebook" target="_blank" rel="noopener">
  ...
  sizes=" (max-width: 1536px) 100vw, 1536px />
                    ...
                    <div class="wp-container-2 wp-block-column">
                        <div class="wp-block-cover is-light has-custom-content-position is-position-bottom-left"><span aria-hidden="true" class="wp-block-cover__background has-background-dim"></span>
                            ...
                            <div class="wp-block-cover__inner-container">
                                <h2 class="has-text-align-left"><a  href="index.php?page=prestation-homme" data-type="page" data-id="2044">Les Prestations homme</a></h2>
                            </div>
                        </div>
                    </div>
                </div>
